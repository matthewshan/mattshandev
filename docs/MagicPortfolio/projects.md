...
The frontmatter is used to set the project's metadata: title, description, optional media, and tags. It's used in the project's page and in meta- and open graph tags.
